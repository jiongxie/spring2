...
<div class="container">
  ...
  <form name="myform" method="post" class="was-validated">
    ...
    <br/>
    <div>
      <button type="button" class="btn btn-dark" onclick="fCheck()">공지사항수정</button> &nbsp;
      <button type="reset" class="btn btn-dark">취소</button> &nbsp;
      <button type="button" class="btn btn-dark" onclick="javascript:location.href='${contextPath}/notify/nList';">돌아가기</button>
    </div>
